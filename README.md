...
- after contract drift, review affected model configs
...
- Keep `tools/model_manager_deprecated.py` (or older `tools/model_manager.py`) for assemble/convert packages not supported by specs
