...
_FAMILY_PROFILES: Dict[str, Dict[str, Any]] = {
    "chatterbox": {
        "label": "Chatterbox",
        "workflows": ["clone", "vc"],
        "summary": "Voice-clone TTS with reference WAV; also supports voice conversion.",
    ...
    "index_tts2": {
        "label": "IndexTTS2",
        "workflows": ["clone"],
        "summary": "Expressive Chinese/English TTS with reference-audio cloning.",
        "voice_fields": ["voice_ref"],
        "optional_voice_fields": ["reference_text", "language"],
        "generation_fields": [
            "temperature",
    ...
    "moss_tts_local": {
        "label": "MOSS-TTS-Local",
        "workflows": ["clone"],
        "summary": "MOSS-TTS-Local Transformer voice-clone TTS.",
        "voice_fields": ["voice_ref"],
        "optional_voice_fields": ["reference_text", "language"],
        "generation_fields": ["text_chunk_size"],
        "request_option_fields": [
    ...
    "moss_tts_nano": {
        "label": "MOSS-TTS-Nano",
        "workflows": ["clone"],
        "summary": "Compact MOSS-TTS-Nano voice-clone TTS; reference transcript improves alignment.",
        "voice_fields": ["voice_ref"],
        "optional_voice_fields": ["reference_text"],
        "generation_fields": ["text_chunk_size"],
        "request_option_fields": [
