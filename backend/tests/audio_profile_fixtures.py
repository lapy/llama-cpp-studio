...
DOC_PROFILED_FAMILIES = [
    ...
    ("tts", "higgs_tts", "speech_defaults", "/v1/audio/speech"),
    ...
    ("asr", "citrinet_asr", "transcription_defaults", "/v1/audio/transcriptions"),
    ...
    ("asr", "hviske_asr", "transcription_defaults", "/v1/audio/transcriptions"),
    ("asr", "hviske", "transcription_defaults", "/v1/audio/transcriptions"),
    ("asr", "nemotron_asr", "transcription_defaults", "/v1/audio/transcriptions"),
    ("asr", "vibevoice_asr", "transcription_defaults", "/v1/audio/transcriptions"),
