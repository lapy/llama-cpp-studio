...
def build_generation_params(architecture: str, context_length: int, preset_overrides: Dict[str, Any] | None) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
    ...
    params["mirostat_tau"] = clamp_float(params.get("mirostat_tau", 5.0), 0.1, 20.0, 5.0)
    params["mirostat_eta"] = clamp_float(params.get("mirostat_eta", 0.1), 0.01, 2.0, 0.1)
